            ...
            <div className="w-full max-w-md relative">
                ...
                <div className="text-center mb-8">
                    <img
                        src="/favicon.png"
                        alt="BatchFund logo"
                        className="h-16 w-16 rounded-2xl object-cover shadow-lg shadow-blue-600/30 mx-auto mb-4"
                    />
                    <h1 className="text-3xl font-bold text-white tracking-tight">
                        BatchFund 21/22
                    </h1>
                    <p className="text-slate-400 mt-1">
                        University Batch Fund Portal
                    </p>
                </div>
                ...
                <Card className="border-0 shadow-2xl shadow-black/20">
                    <CardHeader className="text-center pb-2">
                        ...
                        <CardDescription>
                            Sign in to manage your batch finances
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
